...
class Geocode():
    def __init__(self, min_population_cutoff=1000, large_city_population_cutoff=200000, location_types=None, country_code='FR'):
    ...
    def create_geonames_pickle(self):
        ...
        df.loc[(df.population > self.large_city_population_cutoff) & (df.feature_code_class == 'P') & (~df.is_altname), 'priority'] = 2
        df.loc[(df.country_code == self.country_code), 'priority'] = 1
        # Sorting
